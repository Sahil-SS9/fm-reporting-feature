...
export const mockInvoices: Invoice[] = [
  ...
  },
  {
    ...
    contractorTenant: "Harbor Business Corp", 
    amount: 3800.00,
  ...
  // Recent invoices for current filters (Last 7 days)
  {
    id: "INV026",
    type: "Received",
    invoiceNumber: "MAINT-2024-156",
    description: "Emergency plumbing repair - Kitchen flooding",
    contractorTenant: "QuickFix Plumbing",
    amount: 2850.00,
    dateIssued: "2024-12-09",
    dueDate: "2024-12-16",
    paymentStatus: "Outstanding",
    taxRate: 0.20,
    assignedWorkOrderId: "WO030",
    propertyId: "1"
  },
  {
    id: "INV027",
    ...
    description: "Power surge investigation and repair",
    contractorTenant: "ElectriCorp",
    amount: 4200.00,
    ...
    paymentStatus: "Outstanding",
    taxRate: 0.20,
    assignedWorkOrderId: "WO031",
    propertyId: "2"
  },
  {
    id: "INV028",
    type: "Issued",
    invoiceNumber: "RENT-2024-156",
    description: "December rent - Premium Office Suite 10A",
    contractorTenant: "Executive Solutions Ltd",
    amount: 15000.00,
  ...
  },
  {
    id: "INV029",
    type: "Issued",
    invoiceNumber: "SERV-2024-078",
    description: "Building maintenance service charges - Q4",
    contractorTenant: "Premium Retail Group",
    amount: 5500.00,
    dateIssued: "2024-12-07",
    dueDate: "2024-12-28",
    paymentStatus: "Outstanding",
    taxRate: 0.20,
    propertyId: "3"
  },
  {
    id: "INV030",
    type: "Received",
    invoiceNumber: "CLEAN-2024-167",
    description: "Deep cleaning service - Post renovation cleanup",
    contractorTenant: "DeepClean Specialists",
    amount: 3200.00,
    dateIssued: "2024-12-06",
    dueDate: "2024-12-20",
    paymentStatus: "Overdue",
    taxRate: 0.20,
    assignedWorkOrderId: "WO032",
    propertyId: "4"
  },
  
  // More recent data for different date ranges
  {
    id: "INV031",
    type: "Received",
    invoiceNumber: "HVAC-2024-234",
    description: "HVAC system annual inspection and calibration",
    contractorTenant: "HVAC Solutions Ltd",
    amount: 6800.00,
    dateIssued: "2024-12-01",
    dueDate: "2024-12-31",
    paymentStatus: "Outstanding",
    taxRate: 0.20,
    assignedWorkOrderId: "WO033",
    propertyId: "5"
  },
  {
    id: "INV032",
    type: "Issued",
    invoiceNumber: "PARK-2024-123",
    description: "Monthly parking fees - Executive level",
    contractorTenant: "Business Park Tenants Ltd",
    amount: 2200.00,
    dateIssued: "2024-12-01",
    dueDate: "2024-12-31",
    paymentStatus: "Paid",
  ...
  },
  {
    id: "INV033",
    type: "Received",
    invoiceNumber: "SEC-2024-089",
    description: "Security system monitoring - December",
    contractorTenant: "SecureGuard Systems",
    amount: 1850.00,
    dateIssued: "2024-11-28",
    dueDate: "2024-12-28",
  ...
  },
  {
    id: "INV034",
    type: "Issued",
    invoiceNumber: "UTIL-2024-189",
    description: "Utility recharge and service fees",
    contractorTenant: "Manufacturing Corp",
    amount: 7200.00,
    dateIssued: "2024-11-25",
    dueDate: "2024-12-25",
    paymentStatus: "Outstanding",
  ...
  },
  {
    id: "INV035",
    type: "Received",
    invoiceNumber: "LAND-2024-045",
    description: "Landscaping and grounds maintenance",
    contractorTenant: "GreenThumb Landscaping",
    amount: 2400.00,
    dateIssued: "2024-11-20",
    dueDate: "2024-12-20",
    paymentStatus: "Overdue",
    taxRate: 0.20,
    assignedWorkOrderId: "WO034",
    propertyId: "9"
  },
  
  // Add some older invoices for testing longer date ranges
  {
    id: "INV036",
    type: "Issued",
    invoiceNumber: "RENT-2024-089",
    description: "September rent - Corporate headquarters",
    contractorTenant: "Global Tech Industries",
    amount: 18500.00,
  ...
  },
  {
    id: "INV037",
    type: "Received",
    invoiceNumber: "MAINT-2024-067",
    description: "Quarterly building maintenance inspection",
    contractorTenant: "Building Care Pro",
    amount: 4500.00,
    dateIssued: "2024-08-15",
    dueDate: "2024-09-15",
    paymentStatus: "Paid",
    taxRate: 0.20,
    assignedWorkOrderId: "WO035",
    propertyId: "2"
  },
  {
    id: "INV038",
    type: "Issued",
    invoiceNumber: "SERV-2024-034",
    description: "Common area service charges - Q3",
    contractorTenant: "Retail Partners Ltd",
    amount: 6200.00,
